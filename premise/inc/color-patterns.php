 ...
 */
function Premise_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Premise default saturation level.
	 *
	 * @since Premise 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'Premise_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.Premise-front-page) .entry-title,
...
.colors-custom .Premise-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.Premise-front-page .panel-content .recent-posts article,
...
.colors-custom.Premise-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Premise custom colors CSS.
	 *
	 * @since Premise 1.0
	 *
	 ...
	 */
	return apply_filters( 'Premise_custom_colors_css', $css, $hue, $saturation );
}
